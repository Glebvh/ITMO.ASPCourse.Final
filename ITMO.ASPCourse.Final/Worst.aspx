<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Worst.aspx.cs" Inherits="Worst" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    <div>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:WebFinalDBConnectionString %>" 
                SelectCommand="select top 5 Name, Sum(result) as Result from [StudentDatas] where Name = Name group by Name order by Result asc
">
            </asp:SqlDataSource>
